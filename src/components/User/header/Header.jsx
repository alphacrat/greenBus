...
import image from '/home/bismoy/Documents/mini_project/Green_bus/src/assets/logo.png';
...
const Header = () => {
    ...
    const isOperatorDashboard = location.pathname.startsWith('/operator/dashboard');
    const companyName = isOperatorDashboard ? decodeURIComponent(location.pathname.split('/')[3]) : null;
        ...
        <div className='header-main-container'>
            <HeaderContainer>
                <LogoContainer>
                    ...
                    <HeaderTitle>{isOperatorDashboard ? companyName : 'greenBus'}</HeaderTitle>
                </LogoContainer>
                <ButtonContainer>
